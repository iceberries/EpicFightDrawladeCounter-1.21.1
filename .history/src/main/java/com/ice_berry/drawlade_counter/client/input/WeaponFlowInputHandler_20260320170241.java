...
import com.ice_berry.drawlade_counter.capability.WeaponFlowCapabilityProvider;
...
public class WeaponFlowInputHandler {
    ...
    private static void switchWeapon(LocalPlayer player, boolean next) {
        IWeaponFlowCapability cap = WeaponFlowCapabilityProvider.getCapability(player);
        if (cap == null) return;
