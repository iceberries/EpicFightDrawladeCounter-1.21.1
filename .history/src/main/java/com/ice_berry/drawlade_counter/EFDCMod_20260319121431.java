...
@Mod(EpicFightDrawladeCounter.MODID)
public class EpicFightDrawladeCounter {
    ...
    public EpicFightDrawladeCounter(IEventBus modEventBus, ModContainer modContainer) {
